"""
Django settings for InverMonitor project.
...
SECRET_KEY = 'django-insecure-q!7)=yg_7_ouo#ayo0x#*$m%38c4^h_)88bske3ylho7r-rbf%'
...
INSTALLED_APPS = [
    ...
    'AppInverMonitor.apps.AppInverMonitorConfig',
]
...
ROOT_URLCONF = 'InverMonitor.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'AppInverMonitor' / 'Templates', ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'InverMonitor.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    BASE_DIR / 'AppInverMonitor' / 'Static',
]
STATICFILES_FINDERS = [
